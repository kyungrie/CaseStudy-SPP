          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="action-create.php" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="" for="kompetensi_keahlian">Kompetensi Keahllian</label>
                  <div class="row">
                    <div class="col">
                      <select class="form-select" name="kompetensi_keahlian" id="kompetensi_keahlian" tabindex="3" required>
